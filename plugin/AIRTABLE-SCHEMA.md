...
| `Sponsor Company Name` | Single line text | **Who backs this person's community work — Automattic included.** Fill in the sponsoring or employing company for anyone doing this work as a sponsored/paid role; leave blank only for genuinely unsponsored volunteers and freelancers. Non-empty triggers the "Sponsored" badge, so the badge reads as "someone pays for this person's time," not "someone other than Automattic does." <br><br>⚠️ **Corrected 2026-07-31.** This row previously said "Leave blank for Automatticians," describing a *freelancer vs. Automattician* axis. That was a mis-transcription of Karen's ask — she trailed off mid-sentence and never said "Automattician." The real axis is **unsponsored freelancers vs. sponsored contributors, whoever the sponsor is** (Kinsta, Weglot, Hostinger, WPVibes, Themeisle and Automattic all appear in the data). The data has followed the corrected framing since; this row had not. See `FUTURE_COREY.md` §3. <br><br>Known gap: this single field cannot distinguish an Automattic **employee** from a Five-for-the-Future **sponsored** contributor (Lidia Arroyo Vargas, Pooja Derashri, Francesco Di Candia are sponsored, not employed). Needs Corey's call. |
